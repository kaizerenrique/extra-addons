...
class PosPaymentMethod(models.Model):
	...
	pago_usd = fields.Boolean("Moneda secundaria", help="Seleccione esta opcion si esta es una moneda secundaria, de modo que se pueda introducir pagos con el valor que corresponde en esta moneda segun la tasa")
